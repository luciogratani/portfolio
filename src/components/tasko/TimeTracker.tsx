...
// Port di components/dashboard/time-tracker.tsx.
      ...
      <div className="relative z-10">
        ...
        <div className="flex gap-3">
          <Button
            ...
            size="icon"
            className="w-10 h-10 rounded-full bg-tasko-background text-tasko-foreground hover:bg-tasko-background/90 transition-all duration-300 hover:scale-110"
          >
          ...
          <Button
            ...
            size="icon"
            className="w-10 h-10 rounded-full bg-tasko-destructive hover:bg-tasko-destructive/90 transition-all duration-300 hover:scale-110"
          >
