...
// Port di components/dashboard/mobile-app-card.tsx.
...
export function MobileAppCard() {
  return (
    <Card
      className="bg-tasko-foreground text-tasko-background p-4 transition-all duration-500 hover:shadow-2xl animate-slide-in-up overflow-hidden relative group"
      style={{ animationDelay: "900ms" }}
    >
      <div className="absolute bottom-0 left-0 right-0 h-24 overflow-hidden">
        <svg className="absolute bottom-0 w-full" viewBox="0 0 200 60" preserveAspectRatio="none" style={{ height: "100px" }}>
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col gap-2 mb-4">
          <Button
            variant="secondary"
            className="w-full h-10 bg-tasko-background text-tasko-foreground hover:bg-tasko-background/90 transition-all duration-300 hover:scale-105 flex items-center justify-start gap-2 px-3"
          >
