        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-black text-[#121212] tracking-tighter mt-2 overflow-hidden">
            <motion.span
              ...
              whileInView={{ y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6, ease: [0.25, 0.4, 0.25, 1] as [number, number, number, number], delay: 0.2 }}
            >
              EXPERIENCE{" "}
            </motion.span>
            <motion.span
              ...
              whileInView={{ y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6, ease: [0.25, 0.4, 0.25, 1] as [number, number, number, number], delay: 0.3 }}
            >
              GIGI
            </motion.span>
          </h2>
