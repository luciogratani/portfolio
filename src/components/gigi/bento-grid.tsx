...
function FeatureCard({ feature, index }: { feature: (typeof features)[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ duration: 0.5, delay: index * 0.1, ease: [0.25, 0.4, 0.25, 1] as [number, number, number, number] }}
      ...
      <div className="relative bg-[#1a1a1a] rounded-2xl p-5 border border-white/10 overflow-hidden h-full">
        ...
        <div className="relative z-10 flex flex-col h-full min-h-[140px]">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8, delay: 0.4 + index * 0.1, ease: [0.25, 0.4, 0.25, 1] as [number, number, number, number] }}
          />
        </div>
      </div>
    </motion.div>
        ...
        >
          ...
          <div className="overflow-hidden mt-2">
            <motion.h2
              ...
              transition={{ duration: 0.6, ease: [0.25, 0.4, 0.25, 1] as [number, number, number, number], delay: 0.15 }}
            >
              Formula & Benefits
            </motion.h2>
          </div>
